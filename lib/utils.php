...
function sendSMS($phone, $message = '') {
    try {
        if ($phone != '') {
            ...
            $client = new SoapClient($sms_url . '/aber.asmx?WSDL', array("trace" => 1, "exception" => 0));
            //$client = new SoapClient('http://192.168.72.41/aber.asmx?WSDL', array("trace" => 1, "exception" => 0));
