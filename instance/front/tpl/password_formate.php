<div class="container" style="background-color: white;width: 700px;height: 325px;border: 1px solid #dadada;font-family: tahoma">
    <div class="heading" style="border-bottom: 1px solid #dadada;padding-left: 10px;margin-top: 15px;font-weight: 100">
        <div class="col s8 logo" style="text-align: left;">
            ...
            <span style="font-weight:bold;font-size:50px;color: #0F9D58;text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;">KS Labs</span>
            <!--<img src="<?php print _MEDIA_URL ?>/images/aber-Logos.png" style="height: 80px;width: 80px;" alt="">-->
    ...
    <div class="detail">
        ...
        <div style="margin: 30px 0 15px 20px;">
            <a href="<?php echo _U; ?>reset_password/<?php echo $user_name['email'] ?>" style="background-color: #77C37A;padding: 10px;width: 167px;font-size:20px;cursor: pointer;color: white;text-decoration: none"><?php print _t('229', 'Reset password'); ?></a>
        </div>
    </div>
</div>